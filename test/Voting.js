...
contract("Voting", function (accounts) {
    ...
    describe("2 --- Proposals Registration Started ---", function () {
        ...
        it("shouldn't add a proposal if the workflow status is not set to RegisteringVoters", async function() {
            await VotingInstance.startProposalsRegistering({ from: owner });
            await VotingInstance.endProposalsRegistering({ from: owner });
    ...
    describe("4 --- Voting Session Started ---", function () {
        ...
        it("should change status to start voting", async function () {
